...
<template>
  ...
  <div class="container mx-auto py-10 md:px-15 px-5 ">
    ...
    <h1 class="text-center md:text-4xl  text-(--primary) font-bold mb-10">
      GURU & STAFF
      <span class="bg-(--tk) text-white px-3 py-1 rounded-2xl">TK IMANNUEL</span>
    </h1>
</div>
    ...
    <div
      ...
      class="flex md:px-0 px-5 justify-evenly gap-10 flex-col md:flex-row flex-wrap"
    >
      <div
      ...
      >
        <div
          class="text-center bg-(--gstk) mx-auto rounded-full hover:bg-(--tk) transition-colors duration-500"
        >
          <img
            v-if="guru.image"
