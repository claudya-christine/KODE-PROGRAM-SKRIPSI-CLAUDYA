...
<template>
  ...
  <div class="container mx-auto py-10 md:px-15 px-5 ">
    <h1 class="text-center md:text-4xl text-(--primary) font-bold mb-10">
      GURU & STAFF
      <span class="bg-(--sd) text-white px-3 py-1 rounded-2xl">SDS PROTESTAN</span>
    </h1>
    ...
    >
      ...
      >
        <div
          class="text-center bg-(--gssd) mx-auto  rounded-full hover:bg-(--sd) transition-colors duration-500"
        >
          <img
            v-if="guru.image"
