...
const fetchData = async (page = 1) => {
  try {
    let url = `${API_BASE_URL}/api/v1/kegiatan?page=${page}`;
...
const deleteData = async (id) => {
  ...
  try {
    await axios.delete(`${API_BASE_URL}/api/v1/kegiatan/${id}`);
...
<template>
  <div class="flex">
    ...
    <div class="w-screen p-6">
      <h2 class="text-left text-2xl font-bold mb-6">Kegiatan</h2>
        ...
        <table class="w-full text-sm text-left border-collapse border border-gray-400">
          <thead class="text-xs uppercase text-center">
            <tr>
              ...
              <th class="px-6 py-3 border border-gray-300">Nama Kegiatan</th>
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 text-center py-3 border border-gray-300">{{ item.namaKegiatan }}</td>
              ...
              <td class="px-4 text-center py-3">
                <router-link :to="'/editKegiatan/' + item.id">
