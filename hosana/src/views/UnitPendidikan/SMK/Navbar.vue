...
<template>
  <header class="sticky top-0 z-50 bg-(--smk) py-4 px-5 md:px-0">
    <div class="container mx-auto flex justify-between items-center md:px-10">
      ...
      <nav 
        ...
        bg-(--smk) md:bg-transparent md:flex md:items-center 
        ...
        <ul class="text-white text-xs md:flex md:items-center py-3 md:py-0 px-1">
          ...
          >
            ...
            <ul 
              ...
              class="bg-[#1d4f82] md:bg-white md:absolute md:top-full md:left-0 md:mt-2 shadow-lg md:min-w-[200px] z-50 transition duration-300 ease-in-out"
            >
              <li 
